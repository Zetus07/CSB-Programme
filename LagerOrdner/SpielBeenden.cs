internal static class SpielBeenden
{
    public static void Beenden(int pEingabe, char[] pFeld, char[] pspielerSymbol)
    {
        ...
        else if (pFeld[0] == 'o' && pFeld[4] == 'o' && pFeld[8] == 'o' || pFeld[2] == 'o' && pFeld[4] == 'o' && pFeld[6] == 'o')
        {
            Console.WriteLine($"Spieler {pspielerSymbol[1]} hat gewonnen ");
